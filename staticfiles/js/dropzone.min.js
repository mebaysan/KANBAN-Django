...
var _createClass = function () {
    ...
    function b(a, c) {
        ...
        var d = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this)), e = void 0,
            f = void 0;
    ...
    return _inherits(b, a), _createClass(b, null, [{
        key: "initClass", value: function () {
            this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                ...
                resize: function (a, b, c, d) {
                    var e = {srcX: 0, srcY: 0, srcWidth: a.width, srcHeight: a.height}, f = a.width / a.height;
        ...
        key: "getFilesWithStatus", value: function (a) {
        ...
        key: "_getParamName", value: function (a) {
        ...
        key: "_renameFile", value: function (a) {
        ...
        key: "handleFiles", value: function (a) {
            for (var b = a, c = 0, b = b; ;) {
                var d;
                if (c >= b.length) break;
                d = b[c++];
        ...
        key: "_addFilesFromItems", value: function (a) {
            var b = this;
            return function () {
        ...
        key: "_addFilesFromDirectory", value: function (a, b) {
        ...
        key: "enqueueFiles", value: function (a) {
            for (var b = a, c = 0, b = b; ;) {
                var d;
                if (c >= b.length) break;
                d = b[c++];
        ...
        key: "enqueueFile", value: function (a) {
            var c = this;
        ...
        key: "_enqueueThumbnail", value: function (a) {
            var b = this;
        ...
        key: "removeFile", value: function (a) {
        ...
        key: "removeAllFiles", value: function (a) {
            null == a && (a = !1);
        ...
        key: "resizeImage", value: function (a, c, d, e, f) {
            var g = this;
        ...
        key: "createThumbnail", value: function (a, b, c, d, e, f) {
        ...
        key: "createThumbnailFromUrl", value: function (a, b, c, d, e, f, g) {
            ...
            return g && (i.crossOrigin = g), i.onload = function () {
                ...
                return "undefined" != typeof EXIF && null !== EXIF && e && (g = function (a) {
                    ...
                    var g = h.options.resize.call(h, a, b, c, d), j = document.createElement("canvas"),
                        k = j.getContext("2d");
        ...
        key: "processQueue", value: function () {
            var a = this.options.parallelUploads, b = this.getUploadingFiles().length, c = b;
            if (!(b >= a)) {
        ...
        key: "processFiles", value: function (a) {
            for (var c = a, d = 0, c = c; ;) {
                var e;
                if (d >= c.length) break;
                e = c[d++];
        ...
        key: "_getFilesWithXhr", value: function (a) {
            return this.files.filter(function (b) {
                return b.xhr === a
            }).map(function (a) {
                return a
        ...
        key: "cancelUpload", value: function (a) {
        ...
        key: "resolveOption", value: function (a) {
        ...
        key: "uploadFile", value: function (a) {
            return this.uploadFiles([a])
        }
    }, {
        key: "uploadFiles", value: function (a) {
            var c = this;
                ...
                if (a[0].upload.chunked) {
                    ...
                    var h = function () {
                        ...
                        if (!(d >= e.upload.totalChunkCount)) {
                            g++;
                            var h = d * c.options.chunkSize, i = Math.min(h + c.options.chunkSize, e.size), j = {
        ...
        key: "_getChunk", value: function (a, b) {
        ...
        key: "_uploadData", value: function (a, c) {
            ...
            var i = this.resolveOption(this.options.method, a), j = this.resolveOption(this.options.url, a);
        ...
        key: "_updateFilesUploadProgress", value: function (a, b, c) {
            var d = void 0;
            if (void 0 !== c) {
        ...
        key: "_finishedUploading", value: function (a, c, d) {
            var e = void 0;
        ...
        key: "submitRequest", value: function (a, b, c) {
            a.send(b)
        }
    }, {
        key: "_finished", value: function (a, c, d) {
            for (var e = a, f = 0, e = e; ;) {
                var g;
                if (f >= e.length) break;
                g = e[f++];
        ...
        key: "_errorProcessing", value: function (a, c, d) {
            for (var e = a, f = 0, e = e; ;) {
                var g;
                if (f >= e.length) break;
                g = e[f++];
...
Dropzone.initClass(), Dropzone.version = "5.5.1", Dropzone.options = {}, Dropzone.optionsForElement = function (a) {
    ...
    var a = !0;
    if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (var b = Dropzone.blacklistedBrowsers, c = 0, b = b; ;) {
        var d;
        if (c >= b.length) break;
        d = b[c++];
        var e = d;
...
var detectVerticalSquash = function (a) {
    var b = (a.naturalWidth, a.naturalHeight), c = document.createElement("canvas");
    ...
    return _createClass(a, null, [{
        ...
        key: "restore", value: function (a, b) {
            if (!a.match("data:image/jpeg;base64,")) return b;
            var c = this.decode64(a.replace("data:image/jpeg;base64,", "")), d = this.slice2Segments(c),
                e = this.exifManipulation(b, d);
            return "data:image/jpeg;base64," + this.encode64(e)
        }
    }, {
        key: "exifManipulation", value: function (a, b) {
            var c = this.getExifArray(b), d = this.insertExif(a, c);
            return new Uint8Array(d)
        }
    }, {
        key: "getExifArray", value: function (a) {
        ...
        key: "insertExif", value: function (a, b) {
            var c = a.replace("data:image/jpeg;base64,", ""), d = this.decode64(c), e = d.indexOf(255, 3),
                f = d.slice(0, e), g = d.slice(e), h = f;
            return h = h.concat(b), h = h.concat(g)
        }
    }, {
        key: "slice2Segments", value: function (a) {
            for (var b = 0, c = []; ;) {
                var d;
        ...
        key: "decode64", value: function (a) {
            var b = void 0, c = void 0, d = "", e = void 0, f = void 0, g = void 0, h = "", i = 0, j = [],
                k = /[^A-Za-z0-9\+\/\=]/g;
...
var contentLoaded = function (a, b) {
    var c = !1, d = !0, e = a.document, f = e.documentElement,
        ...
        h = e.addEventListener ? "removeEventListener" : "detachEvent", i = e.addEventListener ? "" : "on",
        j = function d(f) {
